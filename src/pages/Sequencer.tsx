  ...
  },
  {
    ...
    nz: {
      ...
      steps: [
        ...
        { title: 'Check the concrete', body: 'Docket shows batch time, MPa, slump, additives. Confirm it matches the order. Do a slump test if you\'re not sure — flag anything way out with the driver before discharge.', watchFor: 'Concrete life is 90 min from batch. Check the batch time on the docket — if it\'s pushing that limit, decide with the driver before you start placing.' },
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Check the concrete', body: 'Docket shows batch time, MPa, slump, additives. Confirm against order. Do a slump test if you\'re not sure — flag anything way out with the driver before discharge.', watchFor: 'Concrete life is 90 min from batch under AS 1379. Check batch time on the docket — if it\'s pushing that limit, decide with the driver before you start placing.' },
