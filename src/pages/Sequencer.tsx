  ...
  },
  {
    ...
    nz: {
      ...
      steps: [
        ...
        { title: 'Fit brace panels while flat', body: 'Screw or nail brace panels to studs + plates per plan. GIB Braceline fixing pattern from each corner: 50, 50, 50, 75, 75, then 150 mm centres around the perimeter. 12 mm plywood panels: perimeter 150 mm c/c + intermediate studs 300 mm c/c per NZS 3604 §5.4. Do it while the wall is on the floor — much easier than working overhead.', watchFor: 'Skipping a nail on a brace panel drops its bracing capacity. Count nails on each panel before you stand the wall — inspector counts them too.' },
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Fit brace panels while flat', body: 'Screw or nail structural plywood brace panels (12 mm F8 min) to studs + plates per plan. AS 1684.2 exterior ply pattern: 30×2.5 or 50×3.15 galv flat-head nails, 50 mm from panel edge on all sides, then 150 mm c/c around the perimeter + 300 mm c/c on intermediate studs. Do it while flat, not overhead.', watchFor: 'Skipping a nail drops brace capacity. Count nails on each panel before standing — certifier counts them too.' },
