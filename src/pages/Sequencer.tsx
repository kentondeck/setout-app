  ...
  // ─── Doors & windows — installed once building is weather-tight ──────────
  {
    ...
    nz: {
      ...
      steps: [
        ...
        { title: 'Position window in opening', body: 'Lift into opening, sit on sill packers to bring to correct RL. Pack jambs so the interior face of the window jamb sits 10 mm proud of the framing — that gives the gib a flush finish against the reveal. Plumb + level in both directions.', watchFor: 'Windows out of level bind on the sash rails. Get level within 2 mm before screwing off.' },
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Position window in opening', body: 'Lift into opening, sit on sill packers to correct RL. Pack jambs so the interior face of the window jamb sits 10 mm proud of the framing — that gives the plasterboard a flush finish against the reveal. Plumb + level both directions.', watchFor: 'Out-of-level windows bind on the sash rails. Level within 2 mm before screwing.' },
