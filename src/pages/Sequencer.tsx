  ...
  // ─── Framing & structure ─────────────────────────────────────────────────
  {
    ...
    nz: {
      ...
      steps: [
        ...
        { title: 'Set out joist positions on the bearers', body: 'Start at one end and step off at the design c/c (typically 450, or 400 / 600 per plan) all the way to the other end. Keep every centre consistent — the leftover at the last bay is smaller than the rest, but every joist in between lands on plan. Sheet joins land on those centres, so a drifting c/c means every sheet cut is different.', watchFor: 'Match joist positions under any internal load-bearing walls above — the wall load has to land on a joist, not span between two.' },
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Set out joist positions on the bearers', body: 'Start at one end and step off at the design c/c (typically 450, or 600 per plan) all the way to the other end. Keep every centre consistent — the leftover at the last bay is smaller than the rest, but every joist in between lands on plan. Sheet joins land on those centres, so a drifting c/c means every sheet cut is different.', watchFor: 'Match joist positions under load-bearing walls above — the wall load must land on a joist, not span between two.' },
