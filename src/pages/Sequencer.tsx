...
const PHASES: Phase[] = [
  ...
  { key: 'rough-in',          label: 'Services rough-in',           detail: 'Plumbing, electrical, gas, HVAC, insulation — walls still open.' },
  ...
  { key: 'second-fix-trades', label: '2nd-fix trades',              detail: 'Taps, WC, vanity basin, GPOs, switches, light fittings, HVAC fit-off.' },
...
const JOBS: Job[] = [
  ...
  },
  {
    ...
    category: 'services',
    phase: 'rough-in',
    label: 'HVAC duct + head-unit rough-in',
    summary: 'Licensed refrigeration / HVAC installer. Ducts through ceiling space, indoor head brackets, condensate drain roughed.',
    nz: {
      tools: ['(Licensed HVAC installer brings own tools)'],
      materials: ['(HVAC installer supplies duct, indoor head brackets, refrigerant pipe, condensate drain)'],
      steps: [
        { title: 'Confirm a licensed HVAC installer is booked', body: 'Refrigerant handling requires an Approved Filler certificate (EPA). Book the HVAC installer during framing so ducts + refrigerant pipe can be run before linings + insulation go in.', watchFor: 'Trying to fit ducts through a lined ceiling = ripping linings out. Schedule during rough-in, not after.' },
        ...
        { title: 'Sign off + keep the paperwork', body: 'HVAC installer issues certification for the refrigerant + electrical connections. Keep the paperwork for the CCC application.', watchFor: 'A missing HVAC compliance certificate holds up the CCC. Chase it once the work\'s done.' },
      ],
    },
    au: {
      tools: ['(Licensed HVAC installer brings own tools)'],
      materials: ['(HVAC installer supplies duct, indoor head brackets, refrigerant pipe, condensate drain)'],
      steps: [
        { title: 'Confirm a licensed HVAC installer is booked', body: 'Refrigerant handling requires an ARC-licensed installer (Australian Refrigeration Council). Book during framing so ducts + refrigerant pipe run before linings + insulation.', watchFor: 'Ducts through lined ceilings = ripping linings out. Schedule during rough-in.' },
        ...
        { title: 'Sign off + keep the paperwork', body: 'HVAC installer issues compliance paperwork for refrigerant + electrical work. Keep it for the final building surveyor sign-off.', watchFor: 'Missing paperwork holds up final sign-off. Chase it once the work\'s done.' },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    nz: {
      ...
      steps: [
        { title: 'Confirm every trade has signed off their rough-in', body: 'Plumber, electrician, gasfitter, HVAC — each with their compliance paperwork. Any outstanding = don\'t close up walls yet.', watchFor: 'Closing up before sign-off means opening back up when the inspector wants to see something. Chase the paperwork first.' },
    ...
    au: {
      ...
      materials: ['(No materials — inspection only)'],
      steps: [
        { title: 'Confirm every trade has signed off their rough-in', body: 'Plumber, electrician, gasfitter, HVAC — each with compliance paperwork. Any outstanding = don\'t close up.', watchFor: 'Closing up before sign-off = opening back up when the inspector wants to see something. Paperwork first.' },
  ...
  },
  {
    ...
    category: 'services',
    phase: 'second-fix-trades',
    label: 'Electrical + HVAC 2nd fix',
    summary: 'Licensed electrician + HVAC installer. All powerpoints, switches, light fittings, HVAC head units + commissioning, appliance wiring.',
    nz: {
      tools: ['(Licensed electrician + HVAC installer bring own tools)'],
      materials: ['(Trades supply face plates, light fittings, head units, registers)'],
      steps: [
        { title: 'Confirm sparky + HVAC installer are booked + fittings on site', body: 'A registered electrician fits off all powerpoints, switches, light fittings, and appliance wiring. HVAC installer commissions head units + refrigerant charge. Book after painting is done. Fittings on site: face plates, light fittings, downlights, LED strips, head units.', watchFor: 'Missing light fittings on 2nd-fix day = sparky returns for a half-hour job = charge-out. Everything on site before they arrive.' },
        { title: 'Sign off + keep the paperwork', body: 'Electrician issues an updated Electrical Certificate of Compliance (ECoC) covering 2nd fix. HVAC installer issues their compliance paperwork. Both go with the rough-in certs for the CCC application.', watchFor: 'No 2nd-fix ECoC = no CCC. Chase paperwork same day.' },
      ],
    },
    au: {
      tools: ['(Licensed electrician + HVAC installer bring own tools)'],
      materials: ['(Trades supply face plates, light fittings, head units, registers)'],
      steps: [
        { title: 'Confirm sparky + HVAC installer are booked + fittings on site', body: 'A state-licensed electrician fits off all powerpoints, switches, light fittings, appliance wiring. ARC-licensed HVAC installer commissions head units + refrigerant charge. Book after painting. Fittings on site: face plates, light fittings, downlights, LED strips, head units.', watchFor: 'Missing fittings on 2nd-fix day = trade returns for a half-hour job = charge-out. Everything on site before they arrive.' },
        { title: 'Sign off + keep the paperwork', body: 'Electrician issues a Certificate of Electrical Safety (CES / equivalent) covering 2nd fix. HVAC installer issues compliance paperwork. Both go with rough-in certs for final surveyor sign-off.', watchFor: 'No 2nd-fix CES = no final sign-off. Chase paperwork same day.' },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    nz: {
      ...
      materials: ['Handover pack: keys, appliance manuals, paint colour list, warranty certificates, compliance certificates (CCC, plumbing PS, electrical ECoC, waterproofing PS, gas cert, HVAC cert), maintenance schedule'],
      steps: [
        ...
        { title: 'Walk the house with the client + demo the systems', body: 'Show the client how to operate every appliance, HVAC head unit, hot water controller, alarm, garage door, gate. Show the water main + gas isolation, meter box, hot water cylinder. Let them try each thing so they know before you leave.', watchFor: 'Handing over keys + a folder without a walk-through = 20 callback calls in the first month asking basic operation questions. Ten minutes of demo saves hours later.' },
    ...
    au: {
      tools: ['(No tools — meeting)'],
      materials: ['Handover pack: keys, appliance manuals, paint colour list, warranty certificates, compliance certificates (Occupancy Certificate, plumbing, electrical, waterproofing, gas, HVAC), maintenance schedule'],
      steps: [
        ...
        { title: 'Walk the house + demo the systems', body: 'Show client how to operate every appliance, HVAC head unit, hot water controller, alarm, garage door, gate. Show water main + gas isolation, meter box, hot water unit. Let them try each thing before you leave.', watchFor: 'Keys + folder without walk-through = 20 callbacks in the first month. Ten minutes of demo saves hours.' },
  ...
  // ─── Decking & outdoor — usually last on a new build ─────────────────────
  {
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Cut timber posts to length (skip if steel)', body: 'Timber posts on stirrup: once concrete is set, laser-shoot each stirrup top + calculate post length to hit finished bearer top. Cut all at once, chamfer top for water shed, bolt onto stirrup with M12 galv coach bolts through the pre-drilled holes. Steel posts are already at height from step 2 — skip this step.', watchFor: 'Too short = pack + shim (weak). Too long = the bearer follows the highest post + you get a bowed deck. Measure carefully off the laser.' },
  ...
  },
  {
    ...
    au: {
      tools: ['30 m tape', 'Laser or dumpy + staff', 'Spirit level (long)', 'String line', 'Sledge + spade', 'Post-hole borer', 'Cordless drill / impact driver', 'Drop / circular saw', 'Concrete mixer or wheelbarrow', 'Ladder / trestle'],
      materials: ['Posts: 125×125 or 150×150 H5 treated pine', 'Post brackets: Pryda, Multinail, or Bowmac galv anchors', 'Beams / rafters: 240×45 or 290×45 F17 hardwood or MGP12 pine (or LVL)', 'Purlins / battens: 90×45 H3-treated pine', 'Fixings: M12 galv coach bolts (posts / beams), joist hangers, purlin fixings per plan / manufacturer spec', 'Concrete: N20', 'Roof cover: polycarb (Suntuf, Ampelite), COLORBOND, timber slats, shade sail'],
      steps: [
