  ...
  // ─── Doors & windows — installed once building is weather-tight ──────────
  {
    ...
    nz: {
      ...
      steps: [
        ...
        { title: 'Apply sill + head flashing tapes to the opening', body: 'Butyl or self-adhesive flashing tape across the sill of the framed opening (up each jamb at least 250 mm), AND across the head of the opening (extending down and out at least 150 mm past each top corner onto the wrap). Bond the tape by hand-rolling it — no air pockets. If the plan calls for a metal sill flashing (some cavity systems + absorbent claddings), that goes in first and the sill tape runs over it, sloped OUT so water sheds.', watchFor: 'Cold weather (<10 °C) stops butyl tape adhering. Warm the surface with a heat gun or postpone.' },
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Apply sill + head flashing tapes to the opening', body: 'Butyl or self-adhesive flashing tape across the sill of the framed opening (up each jamb 250 mm min), AND across the head of the opening (extending down and out at least 150 mm past each top corner onto the wrap). Hand-roll to bond. If the plan calls for a metal sill flashing (some cavity systems + absorbent claddings), that goes in first and the sill tape runs over it sloped OUT.', watchFor: 'Cold weather (<10 °C) stops butyl adhering. Warm with heat gun or postpone.' },
