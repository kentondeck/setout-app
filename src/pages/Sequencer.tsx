  ...
  },
  {
    ...
    nz: {
      ...
      steps: [
        ...
        { title: 'Cut the profile', body: 'Rip most of the waste off with the table saw — set the fence to the offset line and run the straight cuts. Finish the profile detail with a jigsaw + fine-tooth blade. Undercut the back edge by ~5° so the front face of the join closes even if the wall is slightly out.', watchFor: 'Cutting square (no undercut) means the back edge hits first and the front face gaps. Slight undercut always.' },
