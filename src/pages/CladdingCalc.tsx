        ...
        <div style={cardStyle}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              <NumberInput label="Wall height" value={inputs.wallHeight} onChange={set('wallHeight')} units={['mm', 'm']} placeholder="e.g. 2700" />
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              <NumberInput label="Wall width" value={inputs.wallWidth} onChange={set('wallWidth')} units={['mm', 'm']} placeholder="e.g. 5400" />
            </div>
          </div>
