    ...
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ padding: '24px 20px', display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        <div style={cardStyle}>
          ...
          {/* Wall length */}
          <NumberInput label="Wall length" value={inputs.wallLength} onChange={set('wallLength')} units={['mm', 'm']} placeholder="4000" />

          {/* Heights */}
          <div style={{ display: 'flex', gap: 12 }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              <NumberInput label="Low end height" value={inputs.lowHeight} onChange={set('lowHeight')} units={['mm', 'm']} placeholder="2400" hint="floor to top of rake plate" />
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              {mode === 'heights' ? (
                <NumberInput label="High end height" value={inputs.highHeight} onChange={set('highHeight')} units={['mm', 'm']} placeholder="3200" hint="floor to top of rake plate" />
              ) : (
                <NumberInput
                  label="Roof pitch"
                  value={inputs.pitch}
          ...
          <div>
            ...
            {inputs.studSpacing === 'custom' && (
              <div style={{ marginTop: 10 }}>
                <NumberInput label="" value={inputs.customSpacing} onChange={v => setInputs(prev => ({ ...prev, customSpacing: v }))} units={['mm', 'm']} placeholder="300" />
              </div>
            )}
          </div>
