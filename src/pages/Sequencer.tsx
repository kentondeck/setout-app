  ...
  // ─── Framing & structure ─────────────────────────────────────────────────
  {
    ...
    nz: {
      ...
      steps: [
        ...
        { title: 'Set out joist positions on the bearers', body: 'From one end, step off at the design c/c (450, or 400 / 600 per plan) across the run. Keep every centre consistent — the leftover at the last bay is smaller than the rest.', watchFor: 'Joist positions must match the plan — the plan sets the c/c and the location of every joist for a reason.' },
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Set out joist positions on the bearers', body: 'From one end, step off at the design c/c (450, or 600 per plan) across the run. Keep every centre consistent — the leftover at the last bay is smaller than the rest.', watchFor: 'Joist positions must match the plan — the plan sets the c/c and the location of every joist for a reason.' },
