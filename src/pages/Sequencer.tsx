  ...
  },
  {
    ...
    nz: {
      ...
      steps: [
        ...
        { title: 'Lay mesh sheets over chairs', body: 'Position first sheet aligned with the slab edge, keeping 50 mm cover from the boxing (use edge cover blocks). Lay subsequent sheets, lapping by at least 300 mm (or 40× bar diameter, whichever is greater) per NZS 3109.', watchFor: 'Under-sized lap fails the crack-control at the join — inspector will call it out. When in doubt, err longer.' },
