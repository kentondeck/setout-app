...
const JOBS: Job[] = [
  ...
  },
  {
    ...
    nz: {
      tools: ['Coping saw', 'Jigsaw (fine blade)', 'Block plane', 'Tape', 'Combination square', 'Spirit level', 'Pencil', 'Compass / scriber tool', 'Sanding block'],
      ...
      steps: [
        ...
        { title: 'Mark the profile with a scriber tool', body: 'Hold the compass / scriber tool with one leg riding the weatherboard face and the other on the scriber timber. Slide down the full run so the pencil leg traces the weatherboard profile onto the scriber. Keep the tool at a constant angle.', watchFor: 'Tool tilted through the pass = distorted profile. Keep the two legs at the same angle to the wall face the whole way down.' },
        { title: 'Cut the profile', body: 'Coping saw for tight curves + rusticated profiles, jigsaw with a fine-tooth blade for shallower profiles. Undercut the back edge by ~5° so the front face of the join closes even if the wall is slightly out.', watchFor: 'Cutting square (no undercut) means the back edge hits first and the front face gaps. Slight undercut always.' },
        { title: 'Test-fit + plane back', body: 'Offer the scriber back into the corner. Any high spots that stop the front face closing? Mark them, block-plane back, refit. Repeat until the front face sits tight against the weatherboards.', watchFor: 'Filing / planing too far leaves the scriber loose against the weatherboards. Take small passes and re-check often.' },
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Mark the profile with a scriber tool', body: 'Hold the compass / scriber tool with one leg riding the weatherboard face and the other on the scriber timber. Slide down the full run so the pencil leg traces the weatherboard profile onto the scriber. Constant angle throughout.', watchFor: 'Tool tilted through the pass = distorted profile. Same angle to the wall face all the way down.' },
        { title: 'Cut the profile', body: 'Coping saw for tight curves + rusticated profiles, jigsaw with a fine-tooth blade for shallower profiles. Undercut the back edge by ~5° so the front face of the join closes even if the wall is slightly out.', watchFor: 'Cutting square = back edge hits first and the front face gaps. Slight undercut always.' },
        { title: 'Test-fit + plane back', body: 'Offer the scriber back into the corner. Mark high spots that stop the front face closing, block-plane back, refit. Repeat until the front face sits tight.', watchFor: 'Planing too far leaves the scriber loose. Small passes, re-check often.' },
