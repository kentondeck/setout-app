  ...
  // ─── Doors & windows — installed once building is weather-tight ──────────
  {
    ...
    nz: {
      ...
      steps: [
        ...
        { title: 'Apply sill + head flashing tapes to the opening', body: 'Butyl flashing tape across the sill (up each jamb 150 mm) and at each top corner (down and out 150 mm from the corner onto the wrap). Hand-roll to bond. If a metal sill flashing is spec\'d, it goes in first and the sill tape runs over it sloped OUT.', watchFor: 'Cold weather (<10 °C) stops butyl tape adhering. Warm the surface with a heat gun or postpone.' },
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Apply sill + head flashing tapes to the opening', body: 'Butyl flashing tape across the sill (up each jamb 150 mm) and at each top corner (down and out 150 mm from the corner onto the wrap). Hand-roll to bond. If a metal sill flashing is spec\'d, it goes in first and the sill tape runs over it sloped OUT.', watchFor: 'Cold weather (<10 °C) stops butyl adhering. Warm with heat gun or postpone.' },
