            ...
            <>
              <div style={{ display: 'flex', gap: 12 }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <NumberInput label="Length" value={slabFields.length} onChange={setSlab('length')} unit="mm" placeholder="4000" />
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <NumberInput label="Width" value={slabFields.width} onChange={setSlab('width')} unit="mm" placeholder="3000" />
                </div>
              </div>
              <div style={{ display: 'flex', gap: 12 }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <NumberInput label="Thickness" value={slabFields.thickness} onChange={setSlab('thickness')} unit="mm" placeholder="100" />
                </div>
                <div style={{ flex: 1, minWidth: 0 }} />
              </div>
            </>
