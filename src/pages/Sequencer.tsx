...
const JOBS: Job[] = [
  ...
  },
  {
    ...
    nz: {
      ...
      materials: ['GIB Trade Set (pre-mix or bag) — Level 4 finish standard', 'GIB Cove Base for cornice fills', 'GIB Paper Tape (or fibre mesh for corners in some cases)', 'Metal external corner bead OR paper-faced corner tape', 'Fine sanding sponge (P150 + P220)'],
      steps: [
  ...
  },
  {
    ...
    nz: {
      ...
      steps: [
        ...
        { title: 'Install overhead cabinets first', body: 'Fit a hanging rail (EasyGates / similar) along the wall at the correct height. Lift each overhead onto the rail — one person supports while another fixes through the back rail into stud with 65 mm bugle screws.', watchFor: 'Fitting overheads AFTER base cabinets = restricted access + can\'t lift the cabinet high enough. Overheads first, always.' },
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Install overhead cabinets first', body: 'Fit hanging rail along wall at correct height. Lift each overhead onto rail — one supports, another fixes through back rail into stud with 65 mm Type 17s.', watchFor: 'Overheads after base = restricted access + can\'t lift high enough. Overheads first.' },
  ...
  },
  {
    ...
    au: {
      tools: ['Tape', 'Framing square', 'Spirit level', 'Drop / circular saw', 'Jigsaw', 'Cordless drill / impact driver', 'Hammer', 'Spade (for landing pad)', 'Sledge'],
      materials: ['Stringers: 240×45 or 290×45 F17 hardwood or MGP12 pine (H3-treated)', 'Treads: 2× 140×32 hardwood / treated pine per tread or 235×32 single board', 'Risers (optional): 140×19', 'Handrail: 90×45 or 90×70, min 1000 mm above tread nosing (BCA / NCC Vol 2 3.9.2)', 'Balusters: 90×19 or aluminium, max 125 mm gap (some states 100 mm — check)', 'Fixings: 100 mm Type 17 + M12 galv bolts', 'Concrete for base pad'],
      steps: [
        ...
        { title: 'Install handrail + balustrade', body: 'Handrail min 1000 mm above tread nosing (NCC Vol 2 3.9.2). Stairs > 1 m drop = balustrade required, max 125 mm baluster gap (100 mm in some states, e.g. NSW). Fix handrail posts to stringer with M12 bolts.', watchFor: 'Baluster gap over 125 mm fails inspection + is a child-safety issue. Check gap with block.' },
  ...
  },
  {
    ...
    nz: {
      ...
      steps: [
        ...
        { title: 'Locate services inside the wall', body: 'Multi-detector (like a Bosch GMS 120) over the entire opening area to find electrical cables, water pipes, waste stacks. Any service = re-route by a licensed sparky / plumber BEFORE cutting.', watchFor: 'Reciprocating saw through a live cable = ACC claim + house without power. Through a water pipe = flooded floor. Always detect first.' },
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Locate services inside the wall', body: 'Multi-detector over the entire opening area — electrical, water, waste. Any service = re-route by licensed sparky / plumber BEFORE cutting.', watchFor: 'Reciprocating saw through a cable = WorkCover claim + no power. Through a pipe = flooded floor. Detect first.' },
