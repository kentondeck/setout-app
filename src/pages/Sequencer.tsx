  ...
  // ─── Framing & structure ─────────────────────────────────────────────────
  {
    ...
    nz: {
      ...
      steps: [
        ...
        { title: 'Position + level bearers on the piles', body: 'Sit each bearer directly on top of the pile — brackets only if the plan calls for them; most residential subfloors just bear on the pile. Shoot every bearer with the laser to datum + FFL offset. Skew-nail the bearer to the pile (or through the bracket if fitted) per NZS 3604 §5 fastening tables. Adjust with hardwood packers if a pile is low.', watchFor: 'Bearers that aren\'t dead level throw off every joist above them. Sight along after fixing; anything > 3 mm out gets re-shot.' },
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Position + level bearers on the piers', body: 'Sit each bearer directly on top of the pier — brackets only if the plan calls for them; most residential subfloors just bear on the pier. Shoot every bearer with the laser to datum + FFL offset. Fix the bearer to the pier (or through the bracket if fitted) per AS 1684.2 fastening tables. Adjust with hardwood packers if a pier is low.', watchFor: 'In termite-management zones, timber packers can compromise the barrier. Use metal shim packers or approved treated packers only.' },
