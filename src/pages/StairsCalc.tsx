    ...
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ padding: '24px 20px', display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 16, alignItems: 'flex-end' }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              <NumberInput label="Preferred riser" value={inputs.preferredRiser} onChange={set('preferredRiser')} unit="mm" placeholder="e.g. 175" hint={`${STAIR_LIMITS[settings.region].riserMin}–${STAIR_LIMITS[settings.region].riserMax}mm`} />
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
