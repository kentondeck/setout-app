...
const JOBS: Job[] = [
  ...
  },
  {
    ...
    nz: {
      ...
      materials: ['Battens: 20 mm × 45 mm H3.2 kiln-dried pine (per E2/AS1 cavity depth)', 'Fastenings per the cladding manufacturer\'s spec (through batten + wrap into stud)', 'Vermin mesh (galv or SS, ~5 mm mesh) at cavity base', 'Insect screen / cavity closer at top of cavity', 'Neutral-cure sealant'],
      steps: [
    ...
    au: {
      tools: ['Tape', 'Drop / circular saw', 'Cordless drill / impact driver', 'Hammer', 'Utility knife', 'Sealant gun', 'Straight edge'],
      materials: ['Battens: 20 mm × 45 mm H3-treated pine (some states + wind classes 40 mm)', 'Fastenings per the cladding manufacturer\'s spec (through batten + wrap into stud)', 'Vermin mesh (galv or SS, ~5 mm mesh) at cavity base', 'Insect screen / cavity closer at top', 'Neutral-cure sealant'],
      steps: [
