  ...
  },
  {
    ...
    nz: {
      ...
      steps: [
        ...
        { title: 'Photograph each panel', body: 'Wide shot showing the whole panel + nailing pattern before it gets covered. Labels the wall + panel type in the shot. Keep with the job file.', watchFor: 'Once linings go on, no one can verify the bracing was installed. Photos are your defence at final inspection.' },
      ],
    },
    au: {
      ...
      steps: [
        ...
        { title: 'Photograph each panel', body: 'Wide shot showing the whole panel + nailing pattern before it\'s covered. Label the wall + panel type in the shot. Keep with the job file.', watchFor: 'Once cladding / linings go on, bracing can\'t be verified visually. Photos are your defence at final inspection.' },
      ],
    },
  },
  {
