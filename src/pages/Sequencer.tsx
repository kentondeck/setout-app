...
const JOBS: Job[] = [
  ...
  // ─── Doors & windows — installed once building is weather-tight ──────────
  {
    ...
    nz: {
      ...
      materials: ['Window unit (aluminium joinery: APL group — Vantage / Metro / Altherm)', 'Timber or plastic packers', 'Sill flashing (extruded metal, colour-matched)', 'Sill flashing tape (butyl, 300 mm wide typical)', 'Jamb + head flashing tape', 'Neutral-cure sealant (Bostik or Sika)', 'Countersunk screws through window jamb (per manufacturer)'],
      steps: [
        ...
        { title: 'Screw the window into the framing', body: 'Countersunk screws through the aluminium jamb (not the flange) into stud / head / sill — pre-drilled and countersunk so the heads sit below the surface for filling before paint. Fix at the manufacturer\'s spec\'d centres (typically 450–600 mm c/c). Start at one bottom corner, work around to the opposite corner, checking plumb + level as you go.', watchFor: 'Overtightening warps the jamb + cracks the seal. Snug — not gorilla-tight.' },
    ...
    au: {
      tools: ['Tape', 'Spirit level (short + long)', 'Cordless drill / impact driver', 'Drop / circular saw', 'Sealant gun', 'Staple gun', 'Utility knife', 'Hammer', 'Ladder / trestle'],
      materials: ['Window unit (aluminium joinery: A&L / Trend / Rylock / Stegbar) — BAL-rated in bushfire zones', 'Timber or plastic packers', 'Sill flashing (extruded, colour-matched)', 'Sill flashing tape (butyl, 300 mm wide typical)', 'Jamb + head flashing tape', 'Neutral-cure sealant', 'Countersunk screws through window jamb (per manufacturer)'],
      steps: [
        ...
        { title: 'Screw the window into the framing', body: 'Countersunk screws through the aluminium jamb (not the flange) into stud / head / sill — pre-drilled and countersunk so heads sit below the surface for filling before paint. Manufacturer\'s spec\'d centres (typically 450–600 mm c/c). Start bottom corner, work around to opposite corner, checking plumb + level.', watchFor: 'Overtightening warps jamb + cracks the seal. Snug, not gorilla-tight.' },
  ...
  },
  {
    ...
    nz: {
      ...
      materials: ['New window unit (measured to fit existing opening, or new opening framing planned)', 'Sill flashing (extruded metal, colour-matched)', 'Sill flashing tape (butyl, 300 mm wide)', 'Jamb + head flashing tape', 'Building wrap patch (for repair of existing wrap)', 'Countersunk screws through window jamb (per manufacturer)', 'Neutral-cure sealant', 'Timber packers'],
      steps: [
    ...
    au: {
      tools: ['Tape', 'Spirit level (long)', 'Cordless drill / impact driver', 'Reciprocating saw', 'Utility knife', 'Pry bar / flat bar', 'Sealant gun', 'Multi-tool', 'Staple gun', 'Ladder / trestle', 'PPE'],
      materials: ['New window unit (measured to fit existing opening — BAL-rated in bushfire zones)', 'Sill flashing (extruded, colour-matched)', 'Sill flashing tape (butyl, 300 mm wide)', 'Jamb + head flashing tape', 'Building wrap patch', 'Countersunk screws through window jamb (per manufacturer)', 'Neutral-cure sealant', 'Timber packers'],
      steps: [
