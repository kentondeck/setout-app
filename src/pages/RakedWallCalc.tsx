        ...
        <div style={cardStyle}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              <NumberInput label="Low end height" value={inputs.lowHeight} onChange={set('lowHeight')} unit="mm" placeholder="2400" />
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              {mode === 'heights' ? (
                <NumberInput label="High end height" value={inputs.highHeight} onChange={set('highHeight')} unit="mm" placeholder="3200" />
              ) : (
                <NumberInput
                  label="Roof pitch"
                  value={inputs.pitch}
