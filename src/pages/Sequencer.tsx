...
const JOBS: Job[] = [
  ...
  },
  {
    ...
    nz: {
      tools: ['Table saw', 'Jigsaw (fine blade)', 'Block plane', 'Tape', 'Combination square', 'Spirit level', 'Pencil', 'Scribing block (cut to desired offset)', 'Sanding block'],
      ...
      steps: [
        ...
        { title: 'Cut the profile', body: 'Rip most of the waste off with the table saw, cutting freehand carefully along the pencil line. Finish the profile detail with a jigsaw + fine-tooth blade. Undercut the back edge slightly so the front face of the join closes even if the wall is a bit out.', watchFor: 'Cutting square (no undercut) means the back edge hits first and the front face gaps. Slight undercut always.' },
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Mark the profile with a scribing block', body: 'Cut a small block of timber to the width you want to take off the scriber (i.e. the gap you\'re closing). Run the block down the reference surface with a pencil held against the far face of the block — the pencil traces the reference profile onto the scriber, offset by the block width.', watchFor: 'Tilting the block through the pass = distorted line. Keep the block square to the reference surface all the way down.' },
        { title: 'Cut the profile', body: 'Rip most of the waste off with the table saw, cutting freehand carefully along the pencil line. Finish the profile detail with a jigsaw + fine-tooth blade. Undercut the back edge slightly so the front face of the join closes even if the wall is a bit out.', watchFor: 'Cutting square = back edge hits first and the front face gaps. Slight undercut always.' },
