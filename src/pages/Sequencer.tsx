  ...
  // ─── Doors & windows — installed once building is weather-tight ──────────
  {
    ...
    nz: {
      ...
      steps: [
        ...
        { title: 'Apply sill flashing tape', body: 'Butyl or self-adhesive flashing tape across the sill of the framed opening, extending up each jamb at least 250 mm. Bond the tape by hand-rolling it — no air pockets. If the plan calls for a metal sill flashing (some cavity systems + absorbent claddings), that goes in first and the tape runs over it, sloped OUT so water sheds. Head flashing tape follows the same idea but goes on later (after the window + head flashing are in) — it comes down and out at least 150 mm past each top corner onto the wrap.', watchFor: 'Cold weather (<10 °C) stops butyl tape adhering. Warm the surface with a heat gun or postpone.' },
        ...
        { title: 'Tape the head flashing to the wrap', body: 'Once the head flashing is over the top of the window, run flashing tape along its top edge and up onto the wall wrap, extending down and out at least 150 mm past each top corner of the opening (check the manufacturer\'s detail). That seals the top of the flashing so water running down the wrap gets diverted out over the flashing, not behind it.', watchFor: 'Untaped head flashing = water tracks down the wrap and behind the flashing. The tape at the top edge is what stops that.' },
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Apply sill flashing tape', body: 'Butyl or self-adhesive flashing tape across the sill, up each jamb 250 mm min. Hand-roll to bond. If the plan calls for a metal sill flashing (some cavity systems + absorbent claddings), that goes in first with the tape running over it, sloped OUT. Head flashing tape follows the same idea but goes on later (after the window + head flashing are in) — comes down and out 150 mm min past each top corner onto the wrap.', watchFor: 'Cold weather (<10 °C) stops butyl adhering. Warm with heat gun or postpone.' },
