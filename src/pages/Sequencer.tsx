  ...
  },
  {
    ...
    au: {
      ...
      steps: [
        ...
        { title: 'Plumb hinge-side jamb + fix', body: 'Long spirit level on hinge-side jamb. Pack + plumb both faces. Fix through jamb into stud with countersunk screws (pre-drilled, heads sunk below the surface for filling before paint) — one behind each hinge, top, bottom, latch strike height.', watchFor: 'Plumb ONE face at a time — both faces must be plumb. Plumb one plane + tilted other = door sags to one side.' },
